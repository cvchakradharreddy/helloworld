...
function Marker(poiData) {
    ...
    */
    ...
    this.markerDrawable_idle = new AR.ImageDrawable(arworld.markerDrawable_idle, 2.5, {
        zOrder: 0,
        opacity: 1.0,
        /*
    ...
    this.markerDrawable_selected = new AR.ImageDrawable(arworld.markerDrawable_selected, 2.5, {
        zOrder: 0,
        opacity: 0.0,
        onClick: null
    });
    ...
    return function() {
        ...
        if (!Marker.prototype.isAnyAnimationRunning(marker)) {
            if (marker.isSelected) {
                ...
                try {
                    arworld.onMarkerSelected(marker);
                } catch (err) {
                    alert(err);
                }
